...
namespace Project.COMMON.Tools
{
    public static class SessionExtension
    {
        ...
        //Deserialization => Json formatındaki bir bilginin ilgili yapıya dönüştürülmesidir.
        ...
        {
            string objectString = JsonConvert.SerializeObject(value); //Burada bize gelen object değeri JSON formatta bir string'e çevirdik.
